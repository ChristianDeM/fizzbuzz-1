...
app.get("/v1/explorers/stack/:javascript", (request, response) => {
    const stack = request.params.stack;
    const StacksFilter = ExplorerController.getFiltertBystack(stack);
    response.json({stack: request.params.stack, Stack: StacksFilter});
});
